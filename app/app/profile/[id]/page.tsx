...
export default async function ProfilePage({
    ...
    const { data: rawPosts } = await supabase
        .from("posts")
        .select(
            "*, likes(user_id), comments(id), profiles!posts_user_id_fkey(id, display_name, avatar_url)"
        )
        .eq("user_id", id)
    ...
    const joinedDate = new Date(profile.created_at).toLocaleDateString("en-SA", {
        month: "long",
        year: "numeric",
    });
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div className="glass" style={{ borderRadius: 20, overflow: "hidden" }}>
                ...
                <div style={{ padding: "0 1.5rem 1.5rem" }}>
                    ...
                    <div style={{ marginTop: -32, marginBottom: "0.85rem" }}>
                        <div
                            style={{
